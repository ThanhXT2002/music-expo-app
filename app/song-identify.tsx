    ...
    <View style={styles.container}>
      ...
      <View style={styles.mainContent}>
        ...
        <Text style={styles.hintText}>
          {isListening
            ? 'Đưa điện thoại lại gần nguồn phát nhạc'
            : 'Nhận dạng bài hát đang phát xung quanh'}
        </Text>
      </View>
      ...
      {result && (
        <View style={styles.resultSection}>
          <View style={styles.resultCard}>
            ...
            <Pressable
              onPress={() => router.push('/player/identify-result')}
              style={styles.playResultBtn}
            >
              <LinearGradient
                colors={['#B026FF', '#6C5CE7']}
                style={styles.playResultGradient}
              >
