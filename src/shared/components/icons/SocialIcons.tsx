 ...
 * @description SVG brand icons cho các nút đăng nhập mạng xã hội.
 * Sử dụng react-native-svg để render đúng logo thương hiệu.
...
/**
 * Logo Facebook — màu xanh chính thức #1877F2.
 */
...
/**
 * Logo Apple — trắng cho Dark Mode.
 */
