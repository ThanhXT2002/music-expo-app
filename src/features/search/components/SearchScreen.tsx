...
import { View, Text, ScrollView, Pressable, TextInput, FlatList, ActivityIndicator, StyleSheet } from 'react-native';
...
function ArtistResultCard({ artist, onPress }: { artist: Artist; onPress: () => void }) {
  return (
    <Pressable onPress={onPress} style={({ pressed }) => [styles.artistCard, pressed && { opacity: 0.8 }]}>
      ...
      <Text style={styles.artistFollowers} numberOfLines={1}>Nghệ sĩ</Text>
    </Pressable>
  );
}
