...
import { View, Text, ScrollView, RefreshControl, Pressable, Dimensions, StyleSheet } from 'react-native';
    ...
    <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.tabsScroll}>
      {tabs.map((tab, idx) => (
        <Pressable key={tab} style={[styles.filterTab, idx === 0 && styles.filterTabActive]}>
          <Text style={[styles.filterTabText, idx === 0 && styles.filterTabTextActive]}>
            {tab}
          </Text>
        </Pressable>
      ))}
