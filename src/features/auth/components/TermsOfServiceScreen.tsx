...
import {
  ArrowLeft, ScrollText, Copyright, ShieldCheck, Power, Mail, Lightbulb,
    ...
    <View style={styles.flex}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.intro}>
          Bằng việc sử dụng ứng dụng XTMusic, bạn đồng ý với các điều khoản dưới đây. Ứng dụng KHÔNG sử dụng cho mục đích thương mại hoặc kiếm tiền từ bất kỳ cá nhân/tổ chức nào.
        </Text>
            ...
            <View key={i} style={[styles.card, { backgroundColor: card.bg, borderColor: card.color + '40' }]}>
              ...
              {card.extra && (
                <Pressable onPress={() => Linking.openURL(`mailto:${card.extra}`)}>
                  <Text style={[styles.cardText, { color: COLORS.primary, textDecorationLine: 'underline', marginTop: 6 }]}>{card.extra}</Text>
                </Pressable>
              )}
            </View>
          );
